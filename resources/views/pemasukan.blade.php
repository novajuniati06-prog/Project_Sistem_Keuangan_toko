        ...
        <div class="top-action">
            ...
            <div class="left-action">
                ...
                <div class="tabs">
                    ...
                    <a href="{{ route('pemasukan') }}" class="tab-btn active">
                    ...
                    <a href="{{ route('pengeluaran') }}" class="tab-btn">
                ...
                <form method="GET" action="{{ route('pemasukan') }}">
...
>
    ...
    <div class="dropdown">
        ...
        <button type="button" class="add-btn" onclick="toggleMenu()">
...
<a href="#"
   onclick="document.getElementById('excelFile').click()">
    ...
    <a href="{{ route('transaksi.template') }}" class="download-btn">
    ...
    <form action="{{ route('transaksi.import') }}"
          method="POST"
...
<div class="delete-modal" id="tambahModal">
...
<div class="delete-modal" id="editModal">
    ...
    <div class="modal-box">
        ...
        <h2 style="color:#3366ff;">Edit Pemasukan</h2>
